...
ggplot(data=red_wine_sub,aes(x=alcohol,y=citric.acid,colour=quality,size=volatile.acidity))+
  geom_point()
ggplot(data=red_wine_sub,aes(x=alcohol,y=sulphates,colour=quality,size=volatile.acidity))+
  geom_point()
